 ...
 */
class Categories extends \Application\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Application\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Categories' . "\0" . 'title', '' . "\0" . 'Application\\Entity\\Categories' . "\0" . 'thumbnail'];
        }
